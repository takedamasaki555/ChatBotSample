...
namespace Bot.MeetingRoomAssistant.Dialogs
{
    ...
    public class RootDialog : IDialog<object>
    {
        ...
        public virtual async Task MessageReceivedAsync(IDialogContext context, IAwaitable<IMessageActivity> item)
        {
            ...
            await context.PostAsync("会議室アシスタント Bot をご利用する場合は、以下のリンクからログインしてください（別ウィンドウが表示されます）");
        ...
        public virtual async Task CreateEventReceivedAsync(IDialogContext context, IAwaitable<IMessageActivity> item)
        {
            ...
            string response_json = await Events.GetResultAsync(message.Text, AccessToken.Token);
